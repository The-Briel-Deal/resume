...
\begin{itemize}[leftmargin=\parindent, leftmargin=*]
  \item
    ...
    \href{https://github.com/neovim/neovim/issues?q=is%3Apr%20author%3AThe-Briel-Deal}{\underline{\textbf{multiple
    PR's merged in NeoVim}}},
    \href{https://github.com/zigtools/zls/issues?q=is%3Apr%20author%3AThe-Briel-Deal}{\underline{\textbf{ZLS
    (Zig's Language Server)}}}, and \href{https://github.com/wolfpld/tracy/pulls?q=is%3Apr+author%3AThe-Briel-Deal}{\underline{\textbf{Tracy
    (A real time Frame Profiler)}}}.
    
  \item
    A developer who spends his free time building things like 
\end{itemize}
%----------------------------------------------------------------------------------------
%  EXPERIENCE
%----------------------------------------------------------------------------------------
