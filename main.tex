...
\begin{minipage}[t]{0.45\textwidth} % Left column with your name and title, change the width as needed
	...
	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Ford}}}}} % Last name
...
\end{minipage}
\hfill % Automatic horizontal whitespace
\begin{minipage}[t]{0.29\textwidth} % Right column with the first column of icons
	\vspace{-\baselineskip} % Required for vertically aligning minipages
...
\begin{entrylist}
	\entry
		...
		analysts to investigate security breaches in customer
		environments. \\
